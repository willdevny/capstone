			...
			$("#intAbility").change(function() {
				if ($("#intAbility").val() != "") {
					...
					if ($(":input[name=arcanaProf").is("checked")) {
						$(":input[name=arcanca").val($("#intMod").val() + $("#proficiencyInput").val())
					} else { $(":input[name=arcanca").val($("#intMod").val()) }
			...
			$("#wisAbility").change(function() {
				if ($("#wisAbility").val() != "") {
					...
					if ($(":input[name=insightProf").is("checked")) {
						$(":input[name=insightHandling").val($("#wisMod").val() + $("#proficiencyInput").val())
					} else { $(":input[name=insightHandling").val($("#wisMod").val()) }
					if ($(":input[name=medicineProf").is("checked")) {
						$(":input[name=medicineHandling").val($("#wisMod").val() + $("#proficiencyInput").val())
					} else { $(":input[name=medicineHandling").val($("#wisMod").val()) }
					if ($(":input[name=perceptionProf").is("checked")) {
						$(":input[name=perceptionHandling").val($("#wisMod").val() + $("#proficiencyInput").val())
					} else { $(":input[name=perceptionHandling").val($("#wisMod").val()) }
					if ($(":input[name=survivalProf").is("checked")) {
						$(":input[name=survivalHandling").val($("#wisMod").val() + $("#proficiencyInput").val())
					} else { $(":input[name=survivalHandling").val($("#wisMod").val()) }
				}
			});
